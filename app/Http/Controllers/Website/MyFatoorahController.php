...
//-----------------------------------------------------------------------------------------------------------------------------------------
    ...
    public function callback() {
        try {
            ...
            $returnData['InvoiceStatus'] = $data->InvoiceStatus;
            $returnData['InvoiceReference'] = $data->InvoiceReference;
            $returnData['ReferenceId'] = $data->InvoiceTransactions[0]->ReferenceId;
            $returnData['CustomerReference'] = $data->CustomerReference;
            $returnData['CustomerName'] = $data->CustomerName;
            $returnData['CustomerMobile'] = $data->CustomerMobile;
            $returnData['InvoiceDisplayValue'] = $data->InvoiceDisplayValue;
            $returnData['PaymentGateway'] = $data->InvoiceTransactions[0]->PaymentGateway;
            $returnData['Country'] = $data->InvoiceTransactions[0]->Country;
            $returnData['Currency'] = $data->InvoiceTransactions[0]->Currency;
            $returnData['date'] = $data->CreatedDate;
            
            $response = ['IsSuccess' => true, 'Message' => $message, 'Data' => $returnData];
