...
class OrderTrackingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $orderTrackings = $orderTracking->map(function ($orderTracking) use ($lang, $translateColumns, $columnsToRemove) {
            // Convert category model to an array
            $data = $orderTracking->toArray();
        ...
        return ResponseWithSuccessData($lang, $orderTrackings, 1);
    }
