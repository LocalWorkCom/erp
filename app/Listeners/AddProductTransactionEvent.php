...
class AddProductTransactionEvent
{
    ...
    public function handle(ProductTransactionEvent $event): void
    {
        ...
        $order_type = $product->order_details_id;
        $transaction_type = $product->order_addon_id;
        ...
        if ($product->type == 1) {
            ...
            if ($all_product_transactions) {
                foreach ($all_product_transactions as $all_product_transaction) {
                    ...
                    $this->add_product_transaction_log($all_product_transaction->id, $product->type, 'edit', $count, $user_id, $order_id, $order_type, $transaction_type);
            ...
            if ($update_product_transaction) {
                ...
                $this->add_product_transaction_log($update_product_transaction->id, $product->type, 'edit', $count, $user_id, $order_id, $order_type, $transaction_type);
                //end of product transaction log
                ...
                $this->add_product_transaction_log($add_product_transaction->id, $product->type, 'add', $count, $user_id, $order_id, $order_type, $transaction_type);
                //end of product transaction log
    ...
    private function add_product_transaction_log($product_transaction_id, $type, $model_action, $count, $created_by, $order_id = null, $order_type = null, $transaction_type = null)
    {
        //add product transaction log
