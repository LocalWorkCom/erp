...
return [
    ...
    //web
    'correct' => 'صحيح',
    'brand' => 'يجب اختيار براند',
    'img' => 'يجب اختيار صورة',
    'unit' => 'يجب اختيار وحدة',
    'currency' => 'يجب اختيار عملة',
    'category' => 'يجب اختيار الفئة',
    'name_ar' => 'يجب ادخال الاسم بالعربي',
    'name_en' => 'يجب ادخال الاسم بالانجليزي',
    'desc_ar' => 'يجب ادخال الوصف بالعربي',
    'desc_en' => 'يجب ادخال الوصف بالانجليزي',
    'enter_barcode' => 'يجب ادخال الباركود',
    'code' => 'يجب ادخال الكود',
];
