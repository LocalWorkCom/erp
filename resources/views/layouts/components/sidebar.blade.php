    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                @if (auth()->user()->can('store_transactions') ||
                        auth()->user()->can('product_transactions') ||
                        auth()->user()->can('order_transactions'))
                    <li class="slide has-sub">
                        <a href="javascript:void(0);" class="side-menu__item">
                            <span class=" side-menu__icon">
                                <i class='bx bx-cube'></i>
                ...
                @if (auth()->user()->can('countries') ||
                        auth()->user()->can('colors') ||
                        auth()->user()->can('size') ||
                        auth()->user()->can('units') ||
                        auth()->user()->can('point_systems') ||
                        auth()->user()->can('Notification') ||
                        auth()->user()->can('excuse_settings') ||
                        auth()->user()->can('einvoice_settings') ||
                        auth()->user()->can('leave_settings') ||
                        auth()->user()->can('leave_nationals'))
                    <li class="slide has-sub">
                        <a href="javascript:void(0);" class="side-menu__item">
                            <span class=" side-menu__icon">
                                <i class='bx bx-cube'></i>
