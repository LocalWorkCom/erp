<div class="modal fade" tabindex="-1" id="productModal_v1" aria-labelledby="productModalLabel" aria-hidden="true">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="notes my-3">
                            ...
                            <div class="form-floating mt-3">
                                <textarea class="form-control" placeholder="من فضلك اكتب ملاحظتك" id="note" style="height: 100px"></textarea>
                            </div>
                        </div>
        ...
        <div class="modal-body">
          ...
          <div>
            ...
            <div class="notes my-3">
              ...
              <div class="form-floating mt-3">
                <textarea class="form-control" placeholder="من فضلك اكتب ملاحظتك" id="note_v2"
