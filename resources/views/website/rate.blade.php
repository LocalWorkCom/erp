...
@section('content')
    ...
    <section class="comments">
        <div class="container mb-3">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="fw-bold">التقييمات والتعليقات</h4>
                    @if (session('success'))
                            ...
                            <div class="row">
                                <div class="col-md-4 offset-md-1 rate-side py-md-3">
                                    <div class="container-faces">
                                        <div class="feedback">
                                            <div class="rating">
                                                <input type="radio" name="value" id="rating-5" value="5" required>
                                                <label for="rating-5"></label>
                                                <input type="radio" name="value" id="rating-4" value="4" required>
                                                <label for="rating-4"></label>
                                                <input type="radio" name="value" id="rating-3" value="3" required>
                                                <label for="rating-3"></label>
                                                <input type="radio" name="value" id="rating-2" value="2" required>
                                                <label for="rating-2"></label>
                                                <input type="radio" name="value" id="rating-1" value="1" required>
                                            ...
                                            <h4 class="fw-bold pt-md-3">قييم تجربتك</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-7 py-md-3">
                                    <h4 class="fw-bold">أرسل ملاحظاتك</h4>
                                    <h6 class="text-muted">ملاحظاتك قيمة بالنسبة لنا أخبرنا عن تجربتك</h6>
                                    <div class="my-3">
                                        <textarea class="form-control" name="note" rows="3" placeholder="اكتب ملاحظتك"></textarea>
                                    </div>
