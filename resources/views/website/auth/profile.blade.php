                                ...
                                <form method="POST" action="{{ route('website.profile.update') }}">
                                    ...
                                    <div class="mb-3">
                                            ...
                                            <select id="country" name="country_code_profile" class="selectpicker me-2"
                                                ...
                                                @foreach (GetCountries() as $country)
                                                    <option
                                                        ...
                                                        value="{{ $country->phone_code }}" @if (old('country_code_profile', Auth::guard('client')->user()->country_code) == $country->phone_code)
                                                        selected
                                                @endif>
                                                {{ $country->phone_code }}
                                                </option>
                                        ...
                                        @error('country_code_profile')
                                            <div id="country_code_profileError" class="error-message mb-1 text-danger">
                                                {{ $message }}</div>
                                        @enderror
                                    </div>
