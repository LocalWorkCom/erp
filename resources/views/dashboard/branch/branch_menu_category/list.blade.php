                            ...
                            @endif
                                ...
                                @foreach ($branch_menu_categories as $branch_menu_category)
                                    <tr>
                                        ...
                                        <td id="branch_menu_category_status_{{ $branch_menu_category->id }}">{{ ($branch_menu_category->is_active == 1) ? __('branch_menu_category.Active') : __('branch_menu_category.NotActive') }}</td>
                                        <td>
                                            <!-- Show Button -->
