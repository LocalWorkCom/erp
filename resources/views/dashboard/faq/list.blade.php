...
@section('content')
    ...
    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <h4 class="fw-medium mb-0">@lang('term.FAQs')</h4>
        <div class="ms-sm-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.home') }}">@lang('sidebar.Main')</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="" onclick="window.location.href='{{ route('faqs.list') }}'">@lang('term.FAQs')</a></li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        justify-content: space-between;">
                            <div class="card-title">@lang('term.FAQs')</div>
                            ...
                            <table id="file-export" class="table table-bordered text-nowrap" style="width:100%">
                                ...
                                @foreach ($faqs as $faq)
                                    <tr>
                                        ...
                                        <td>{{ $faq->name_en }}</td>
                                        <td>
                                            <a href="{{ route('faq.show', $faq->id) }}" class="btn btn-info-light btn-wave">@lang('category.show') <i class="ri-eye-line"></i></a>
                                            <a href="{{ route('faq.edit', $faq->id) }}" class="btn btn-orange-light btn-wave">@lang('category.edit') <i class="ri-edit-line"></i></a>
