...
@section('content')
                    ...
                    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                        <h4 class="fw-medium mb-0">Data Tables</h4>
                                        ...
                                        <div class="card-body">
                                            <div class="deleted-table table-responsive">
                                                <div class="text-center">
                                                    <button type="button" id="button" class="btn btn-primary btn-sm data-table-btn">Delete selected row</button>
                                                </div>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <div class="text-center">
                                                    <button type="button" id="addRow" class="btn btn-sm btn-primary mb-2 data-table-btn">Add new row</button>
                                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <table id="scroll-vertical" class="table table-bordered text-nowrap" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">Name</th>
                                                        <th scope="col">Position</th>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <table id="hidden-columns" class="table table-bordered text-nowrap" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th>Name</th>
                                                        <th>Position</th>
