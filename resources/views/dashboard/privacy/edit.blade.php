...
@section('content')
    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <h4 class="fw-medium mb-0">@lang('term.EditPrivacy')</h4>
        <div class="ms-sm-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('privacies.list') }}">@lang('term.Privacys')</a></li>
                    <li class="breadcrumb-item active" aria-current="page">@lang('term.EditPrivacy')</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="card-title">@lang('term.EditPrivacy')</div>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                                ...
                                @endforeach
                            @endif
                            <form method="POST" action="{{ route('privacy.update', $privacy->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                                @csrf
                                @method('PUT')
                                <div class="row gy-4">
                                    <!-- Name Fields -->
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" name="name_ar" id="name_ar" class="form-control" value="{{ old('name_ar', $privacy->name_ar) }}" required>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" name="name_en" id="name_en" class="form-control" value="{{ old('name_en', $privacy->name_en) }}" required>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <textarea name="description_ar" id="myeditorinstance_ar" class="form-control">{{ old('description_ar', $privacy->description_ar) }}</textarea>
                                    </div>

                                    <div class="col-xl-6">
                                        <label for="description_en" class="form-label">@lang('term.EnglishDescription')</label>
                                        <textarea name="description_en" id="myeditorinstance_en" class="form-control">{{ old('description_en', $privacy->description_en) }}</textarea>
                                    </div>
