...
@section('content')
    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <h4 class="fw-medium mb-0">@lang('term.AddPrivacy')</h4>
        <div class="ms-sm-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('privacies.list') }}">@lang('term.Privacys')</a></li>
                    <li class="breadcrumb-item active" aria-current="page">@lang('term.AddPrivacy')</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="card-title">@lang('term.AddPrivacy')</div>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                                ...
                                @endforeach
                            @endif
                            <form method="POST" action="{{ route('privacy.store') }}" class="needs-validation" enctype="multipart/form-data" novalidate>
                                @csrf
                                <div class="row gy-4">
                                    <div class="col-xl-6">
