...
@section('content')
    ...
    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <h4 class="fw-medium mb-0">@lang('term.Privacys')</h4>
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        justify-content: space-between;">
                            <div class="card-title">@lang('term.Privacys')</div>
                            <button type="button" class="btn btn-primary label-btn"
                                onclick="window.location.href='{{ route('privacy.create') }}'">
                                <i class="fe fe-plus label-btn-icon me-2"></i>
                                @lang('term.AddPrivacy')
                            </button>
