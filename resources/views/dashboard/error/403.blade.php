                    ...
                    <div class="col-xxl-7 col-xl-8 col-lg-9 rectangle error-authentication ">
                        <div class="text-center authentication-style rectangle1">
                            <div class="lh-1 mb-3">
                                ...
                                <span class="text-warning text-large fw-bold">3</span>
                            </div>
                            <span class="d-block fs-15 mb-3">Oops &#128557;,The page you are looking for is not
                                available for you.</span>
                            <p class="text-muted fw-normal">
                                We are sorry for the inconvenience,The page you are trying to access , you don't have permission to view.
                            </p>
