...
@section('content')
    <div class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
        <h4 class="fw-medium mb-0">@lang('product.EditProduct')</h4>
                            ...
                            <form method="POST" action="{{ route('product.update', $product->id) }}" class="needs-validation" novalidate enctype="multipart/form-data">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <textarea name="description_ar" id="description_ar" class="form-control" rows="2">{{ old('description_ar', $product->description_ar) }}</textarea>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <textarea name="description_en" id="description_en" class="form-control" rows="2">{{ old('description_en', $product->description_en) }}</textarea>
